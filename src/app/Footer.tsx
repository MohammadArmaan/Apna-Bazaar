      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-x-12 gap-y-16 md:col-span-3 lg:grid-cols-6">
          <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            <div className="text-2xl font-bold">Apna Bazaar</div>
            <p className="mt-7 text-base leading-relaxed text-muted-foreground">
              Apna Bazaar is your go-to e-commerce site for affordable,
              high-quality essentials, offering a seamless shopping experience
